...
## Changes
- Added `/Users/freeman/Documents/New project/scripts/check/ols_wp_dryrun_check.sh`.
- Updated `/Users/freeman/Documents/New project/scripts/check/run.sh` to run the OLS+WP dry-run check.
